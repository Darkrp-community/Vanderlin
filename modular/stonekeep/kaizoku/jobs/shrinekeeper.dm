...
/datum/advclass/combat/abyssariad/shrinekeepers //Low-abyssanctum role, but its efficiency requires champion-tier levels entirely because of unarmed skills. They are NOT champions.
	...
	"Ogrun",
	"Undine")
	outfit = /datum/outfit/job/adventurer/abyssariad/shrinekeepers
	category_tags = list(CTAG_ADVENTURER)
	vampcompat = FALSE
	pickprob = 100

/datum/outfit/job/adventurer/abyssariad/shrinekeepers
	allowed_patrons = list(/datum/patron/divine/abyssor)

/datum/outfit/job/adventurer/abyssariad/shrinekeepers/pre_equip(mob/living/carbon/human/H)
	..()
